                            ...
                            @foreach ($colocation->expenses as $expense)
                                <tr class="hover:bg-gray-50/30 transition">
                                    <td class="px-6 py-4">
                                        ...
                                        <p class="text-[10px] text-gray-400 font-medium uppercase tracking-tighter">Payé par {{ $expense->person->firstName }} • {{ $expense->date }}</p>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-[10px] font-black uppercase">{{ $expense->category->title }}</span>
                                    </td>
